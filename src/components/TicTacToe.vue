<template>
    <div class="game-container">
        ...
        <div class="tictactoe-container">
            <GameCell v-for="(cell, i) in cells" :key="i"
                @click:action="play(i)"
                :sign=cells[i]
...
export default {
    ...
    methods: {
        /* toggleStartBanner: toggle the presentation banner & call the setup  */
        toggleStartBanner() {
            this.isStartVisible = !this.isStartVisible
            this.toggleSetupBanner()
        },
        /* toggleSetupBanner: toggle the game setup */
        toggleSetupBanner() {
            this.isSetupVisible = !this.isSetupVisible
        },
        /* toggleEndBanner: toggle the end game banner & call the setup  */
        toggleEndBanner() {
